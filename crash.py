...
with st.sidebar.expander('Active School Zone Flag', expanded=True):
    st.image('https://github.com/dhamijam/ALY6050/blob/main/school.png', width=50)
...
with st.sidebar.expander('Construction Zone Flag', expanded=True):
    st.image('https://github.com/dhamijam/ALY6050/blob/main/construction.png', width=50)
...
with st.sidebar.expander('Crash Time', expanded=True):
    st.image('https://github.com/dhamijam/ALY6050/blob/main/clock.png', width=50)
...
with st.sidebar.expander('Day of Week', expanded=True):
    st.image('https://github.com/dhamijam/ALY6050/blob/main/calendar.png', width=50)
...
with st.sidebar.expander('Roadway Part', expanded=True):
    st.image('https://github.com/dhamijam/ALY6050/blob/main/highway.png', width=50)
...
with st.sidebar.expander('Speed Limit', expanded=True):
    st.image('https://github.com/dhamijam/ALY6050/blob/main/speed.png', width=50)
...
with st.sidebar.expander('Surface Condition', expanded=True):
    st.image('https://github.com/dhamijam/ALY6050/blob/main/snow.png', width=50)
...
with st.sidebar.expander('Person Helmet', expanded=True):
    st.image('https://github.com/dhamijam/ALY6050/blob/main/helmet.png', width=50)
...
def display_severity_icon(severity_category):
    if severity_category == 'Low':
        st.image('images/green.png', caption='Low Severity', use_column_width=150)
    elif severity_category == 'Moderate':
        st.image('images/caution.png', caption='Moderate Severity', use_column_width=150)
    elif severity_category == 'High':
        st.image('images/warning.png', caption='High Severity', use_column_width=150)
    else:
